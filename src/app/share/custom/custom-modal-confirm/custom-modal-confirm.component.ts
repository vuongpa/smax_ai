    ...
    <ng-template #template>
      <div class="custom-modal-confirm">
        ...
        <div class="modal-body text-center">
          <p>
            <span>
              <i class="fas fa-info-circle" style="color: #5288e5;"></i>
            </span>
            {{ modalContent.description }}
          </p>
          <button type="button" class="btn btn-primary button-confirm" (click)="confirm()">
            {{ modalContent.okText }}
          </button>
...
export class CustomModalConfirmComponent {
  ...
  public okFunc?: (ev?: any) => void;
  constructor(private modalService: BsModalService) {}

  openModal(modalContent: IModalConfirmContent, okFunc?: (ev?: any) => void) {
